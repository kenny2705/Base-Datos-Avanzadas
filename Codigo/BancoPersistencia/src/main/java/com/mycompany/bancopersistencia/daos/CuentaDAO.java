...
public class CuentaDAO implements ICuentaDAO {
    ...
    public Cuenta consultarCuentaPorContra(String contra) throws PersistenciaException {
        ...
        try (Connection conexion = this.conexionBD.crearConexion();
            ...
            //regresamos el Cliente consultado
            return cuentaConsultada;
        } catch (Exception e) {
            LOG.log(Level.SEVERE, "contraseña no encontrada", e);
    ...
    public float consultarSaldo(String contra) throws PersistenciaException {
        ...
        try (Connection conexion = this.conexionBD.crearConexion();
            ...
            //regresamos el Cliente consultado
            return cuentaConsultada.getSaldo();
        } catch (Exception e) {
            LOG.log(Level.SEVERE, "saldo bugeado", e);
            throw new PersistenciaException("No se ha encontrado ningún activista", e);
